    ...
    <div class="col-md-6">
        <div style="margin-left: 30px;margin-top: 20px;">
            ...
            <p>
                ...
                <span style="color: #357ebd;font-weight: bold;">eureka.client.serviceUrl.defaultZone=http://eureka.likegirl.cn/eureka/</span>
            </p>
            <br>
            <h3>我的主页</h3>
            <a href="http://www.likegirl.cn/" target="_blank">LikeGirl</a>
        </div>
    </div>
    <div class="col-md-6">
        <div style="margin-left: 30px;margin-top: 20px;">
